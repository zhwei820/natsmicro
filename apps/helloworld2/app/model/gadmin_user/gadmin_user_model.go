...
// arModel is a active record design model for table gadmin_user operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gadmin_user.
	Table = "gadmin_user"
	// Model is the model object of gadmin_user.
