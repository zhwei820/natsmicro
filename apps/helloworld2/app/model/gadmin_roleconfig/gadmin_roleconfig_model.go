...
// arModel is a active record design model for table gadmin_roleconfig operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gadmin_roleconfig.
	Table = "gadmin_roleconfig"
	// Model is the model object of gadmin_roleconfig.
