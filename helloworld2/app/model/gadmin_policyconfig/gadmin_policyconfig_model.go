...
// arModel is a active record design model for table gadmin_policyconfig operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gadmin_policyconfig.
	Table = "gadmin_policyconfig"
	// Model is the model object of gadmin_policyconfig.
