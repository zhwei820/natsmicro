...
// arModel is a active record design model for table gadmin_casbinrule operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of gadmin_casbinrule.
	Table = "gadmin_casbinrule"
	// Model is the model object of gadmin_casbinrule.
